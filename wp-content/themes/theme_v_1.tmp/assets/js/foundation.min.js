...
window.Modernizr = function (e, t, n) {
    ...
    return f.addTest = function (e, t) {
        if (typeof e == "object")for (var r in e)L(e, r) && f.addTest(r, e[r]); else {
            e = e.toLowerCase();
            if (f[e] !== n)return f;
    ...
    k = function (e) {
        ...
        function o(e, i, s, o, u) {
            ...
            a.url.split(".").pop().split("?").shift(), a.bypass || (i && (i = r(i) ? i : i[e] || i[o] || i[e.split("http://theme.crumina.net/").pop().split("?")[0]]), a.instead ? a.instead(e, i, s, o, u) : (T[a.url] ? a.noexec = !0 : T[a.url] = 1, s.load(a.url, a.forceCSS || !a.forceJS && "css" == a.url.split(".").pop().split("?").shift() ? "c" : n, a.noexec, a.attrs, a.timeout), (r(i) || r(f)) && s.load(function () {
...
(function (e) {
    ...
    jQuery.foundation = jQuery.foundation || {}, jQuery.foundation.customForms = jQuery.foundation.customForms || {}, e.foundation.customForms.appendCustomMarkup = function (n) {
        ...
        function s(n, r) {
            var i = t(), s = e(r), o = s.next("div.custom.dropdown"), u = o.find("ul"), a = o.find(".current"), f = o.find(".selector"), l = s.find("option"), c = l.filter(":selected"), h = 0, p = "", d, v = !1;
...
(function (e) {
    ...
    e(document).on("click", "a[data-reveal-id]", function (t) {
        ...
        var r = e(document), i = {animation:"fadeAndPop", animationSpeed:300, closeOnBackgroundClick:!0, dismissModalClass:"close-reveal-modal", open:e.noop, opened:e.noop, close:e.noop, closed:e.noop};
...
(function (e) {
    ...
    var t = {defaults:{animation:"horizontal-push", animationSpeed:600, timer:!0, advanceSpeed:4e3, pauseOnHover:!1, startClockOnMouseOut:!1, startClockOnMouseOutAfter:1e3, directionalNav:!0, directionalNavRightText:"Right", directionalNavLeftText:"Left", captions:!0, captionAnimation:"fade", captionAnimationSpeed:600, resetTimerOnClick:!1, bullets:!1, bulletThumbs:!1, bulletThumbLocation:"", afterSlideChange:e.noop, afterLoadComplete:e.noop, fluid:!0, centerBullets:!0, singleCycle:!1, slideNumber:!1, stackOnSmall:!1}, activeSlide:0, numberSlides:0, orbitWidth:null, orbitHeight:null, locked:null, timerRunning:null, degrees:0, wrapperHTML:'<div class="orbit-wrapper" />', timerHTML:'<div class="timer"><span class="mask"><span class="rotator"></span></span><span class="pause"></span></div>', captionHTML:'<div class="orbit-caption"></div>', directionalNavHTML:'<div class="slider-nav hide-for-small"><span class="right"></span><span class="left"></span></div>', bulletHTML:'<ul class="orbit-bullets"></ul>', slideNumberHTML:'<span class="orbit-slide-counter"></span>', init:function (t, n) {
        var r, i = 0, s = this;
        this.clickTimer = e.proxy(this.clickTimer, this), this.addBullet = e.proxy(this.addBullet, this), this.resetAndUnlock = e.proxy(this.resetAndUnlock, this), this.stopClock = e.proxy(this.stopClock, this), this.startTimerAfterMouseLeave = e.proxy(this.startTimerAfterMouseLeave, this), this.clearClockMouseLeaveTimer = e.proxy(this.clearClockMouseLeaveTimer, this), this.rotateTimer = e.proxy(this.rotateTimer, this), this.options = e.extend({}, this.defaults, n), this.options.timer === "false" && (this.options.timer = !1), this.options.captions === "false" && (this.options.captions = !1), this.options.directionalNav === "false" && (this.options.directionalNav = !1), this.$element = e(t), this.$wrapper = this.$element.wrap(this.wrapperHTML).parent(), this.$slides = this.$element.children("img, a, div, figure"), this.$element.on("movestart", function (e) {
        ...
        this.degrees += 2, this.$rotator.css({"-webkit-transform":t, "-moz-transform":t, "-o-transform":t, "-ms-transform":t}), this.degrees > 180 && (this.$rotator.addClass("move"), this.$mask.addClass("move"));
        ...
        this.locked || (this.lock(), t == "next" ? (this.activeSlide++, this.activeSlide == this.numberSlides && (this.activeSlide = 0)) : t == "prev" ? (this.activeSlide--, this.activeSlide < 0 && (this.activeSlide = this.numberSlides - 1)) : (this.activeSlide = t, this.prevActiveSlide < this.activeSlide ? n = "next" : this.prevActiveSlide > this.activeSlide && (n = "prev")), this.setActiveBullet(), this.notifySlideChange(), this.$slides.eq(this.prevActiveSlide).css({"z-index":2}), this.options.animation == "fade" && (this.$slides.eq(this.activeSlide).css({opacity:0, "z-index":3}).animate({opacity:1}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).animate({opacity:0}, this.options.animationSpeed)), this.options.animation == "horizontal-slide" && (n == "next" && this.$slides.eq(this.activeSlide).css({left:this.orbitWidth, "z-index":3}).css("opacity", 1).animate({left:0}, this.options.animationSpeed, this.resetAndUnlock), n == "prev" && this.$slides.eq(this.activeSlide).css({left:-this.orbitWidth, "z-index":3}).css("opacity", 1).animate({left:0}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).css("opacity", 0)), this.options.animation == "vertical-slide" && (n == "prev" && (this.$slides.eq(this.activeSlide).css({top:this.orbitHeight, "z-index":3}).css("opacity", 1).animate({top:0}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).css("opacity", 0)), n == "next" && this.$slides.eq(this.activeSlide).css({top:-this.orbitHeight, "z-index":3}).css("opacity", 1).animate({top:0}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).css("opacity", 0)), this.options.animation == "horizontal-push" && (n == "next" && (this.$slides.eq(this.activeSlide).css({left:this.orbitWidth, "z-index":3}).animate({left:0, opacity:1}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).animate({left:-this.orbitWidth}, this.options.animationSpeed, "", function () {
            ...
            e(this).css({opacity:0})
        }))), this.options.animation == "vertical-push" && (n == "next" && (this.$slides.eq(this.activeSlide).css({top:-this.orbitHeight, "z-index":3}).css("opacity", 1).animate({top:0, opacity:1}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).css("opacity", 0).animate({top:this.orbitHeight}, this.options.animationSpeed, "")), n == "prev" && (this.$slides.eq(this.activeSlide).css({top:this.orbitHeight, "z-index":3}).css("opacity", 1).animate({top:0}, this.options.animationSpeed, this.resetAndUnlock), this.$slides.eq(this.prevActiveSlide).css("opacity", 0).animate({top:-this.orbitHeight}, this.options.animationSpeed))), this.setCaption()), this.$slides.last() && this.options.singleCycle && this.stopClock()
    }};
...
(function (e, t) {
    ...
    if (!i.getContext)r = !0; else if (i.toDataURL("image/png").indexOf("data:image/png") < 0)r = !0; else var f = i.getContext("2d");
    ...
    e.add_theme = function (t, n) {
        ...
        for (var c = i.length, h = 0; h < c; h++) {
            ...
            if (!!~d.indexOf(n.domain)) {
                var v = !1, m = null, g = null, y = d.substr(d.indexOf(n.domain) + n.domain.length + 1).split("http://theme.crumina.net/");
...
(function (e, t, n) {
    ...
    e.fn.foundationButtons = function (t) {
        var r = e(document), i = e.extend({dropdownAsToggle:!0, activeClass:"active"}, t), s = function (t) {
        ...
        r.on("click.fndtn", ".button.disabled", function (e) {
            ...
            t.target.nodeName !== "A" && t.preventDefault(), s(i.dropdownAsToggle ? u : ""), u.toggleClass("show-dropdown"), i.dropdownAsToggle && (o(r), n.toggleClass(i.activeClass))
        ...
        var u = e(".button.dropdown:not(.large):not(.small):not(.tiny)", this).outerHeight() - 1, a = e(".button.large.dropdown", this).outerHeight() - 1, f = e(".button.small.dropdown", this).outerHeight() - 1, l = e(".button.tiny.dropdown", this).outerHeight() - 1;
...
(function (e, t, n, r) {
    "use strict";
    var i = {callback:e.noop, init:!1}, s = {init:function (t) {
        ...
        o && u.length > 0 && (n.preventDefault(), u.closest(".tabs-content").children("li").removeClass("active").hide(), u.css("display", "block").addClass("active")), r.removeClass("active"), t.addClass("active"), i.callback()
    }};
...
(function (e, t, n) {
    "use strict";
    var r = {bodyHeight:0, selector:".has-tip", tooltipClass:".tooltip", tipTemplate:function (e, t) {
        ...
        var n = e(r.tipTemplate(i.selector(t), e("<div>").html(t.attr("title")).html())), s = i.inheritable_classes(t);
        n.addClass(s).appendTo("body"), Modernizr.touch && n.append('<span class="tap-to-close">tap to close </span>'), t.removeAttr("title"), i.show(t)
        ...
        r.css("visibility", "hidden").show(), s = n.data("width"), o = r.children(".nub"), u = o.outerHeight(), a = o.outerWidth(), l = function (e, t, n, r, i, s) {
            return e.css({top:t, bottom:r, left:i, right:n, width:s ? s : "auto"}).end()
        }, l(r, n.offset().top + n.outerHeight() + 10, "auto", "auto", n.offset().left, s), l(o, -u, "auto", "auto", 10), e(t).width() < 767 ? (f = n.closest(".columns"), f.length < 0 && (f = e("body")), r.width(f.outerWidth() - 25).css("left", 15).addClass("tip-override"), l(o, -u, "auto", "auto", n.offset().left)) : i && i.indexOf("tip-top") > -1 ? (l(r, n.offset().top - r.outerHeight() - u, "auto", "auto", n.offset().left, s).removeClass("tip-override"), l(o, "auto", "auto", -u, "auto")) : i && i.indexOf("tip-left") > -1 ? (l(r, n.offset().top + n.outerHeight() / 2 - u, "auto", "auto", n.offset().left - r.outerWidth() - 10, s).removeClass("tip-override"), l(o, r.outerHeight() / 2 - u / 2, -u, "auto", "auto")) : i && i.indexOf("tip-right") > -1 && (l(r, n.offset().top + n.outerHeight() / 2 - u, "auto", "auto", n.offset().left + n.outerWidth() + 10, s).removeClass("tip-override"), l(o, r.outerHeight() / 2 - u / 2, "auto", "auto", -u)), r.css("visibility", "visible").hide()
    }, inheritable_classes:function (t) {
        var n = ["tip-top", "tip-left", "tip-bottom", "tip-right", "noradius"], r = t.attr("class"), i = r ? e.map(r.split(" "),function (t, r) {
...
(function (e, t, n) {
    ...
    e.fn.foundationAccordion = function (t) {
        var n = e(".accordion");
        n.hasClass("hover") && !Modernizr.touch ? e(".accordion li", this).on({mouseenter:function () {
            console.log("due");
            var t = e(this).parent(), n = e(this).children(".content").first();
            e(".content", t).not(n).hide().parent("li").removeClass("active"), n.show(0, function () {
                n.parent("li").addClass("active")
            })
        }}) : e(".accordion li", this).on("click.fndtn", function () {
            var t = e(this), n = e(this).parent(), r = e(this).children(".content").first();
            t.hasClass("active") ? n.find("li").removeClass("active").end().find(".content").hide() : (e(".content", n).not(r).hide().parent("li").removeClass("active"), r.show(0, function () {
...
(function (e, t, n) {
    "use strict";
    var r = {version:"2.0.1", tipLocation:"bottom", nubPosition:"auto", scrollSpeed:300, timer:0, startTimerOnClick:!0, startOffset:0, nextButton:!0, tipAnimation:"fade", pauseAfter:[], tipAnimationFadeSpeed:300, cookieMonster:!1, cookieName:"joyride", cookieDomain:!1, tipContainer:"body", postRideCallback:e.noop, postStepCallback:e.noop, template:{link:'<a href="#close" class="joyride-close-tip">X</a>', timer:'<div class="joyride-timer-indicator-wrap"><span class="joyride-timer-indicator"></span></div>', tip:'<div class="joyride-tip-guide"><span class="joyride-nub"></span></div>', wrapper:'<div class="joyride-content-wrapper"></div>', button:'<a href="#" class="small button joyride-next-tip"></a>'}}, i = i || !1, s = {}, o = {init:function (n) {
        return this.each(function () {
            if (e.isEmptyObject(s)) {
                s = e.extend(r, n), s.document = t.document, s.$document = e(s.document), s.$window = e(t), s.$content_el = e(this), s.body_offset = e(s.tipContainer).position(), s.$tip_content = e("> li", s.$content_el), s.paused = !1, s.attempts = 0, s.tipLocationPatterns = {top:["bottom"], bottom:[], left:["right", "top", "bottom"], right:["left", "top", "bottom"]}, o.jquery_check(), e.isFunction(e.cookie) || (s.cookieMonster = !1);
...
(function (e, t, n) {
    "use strict";
    var r = {templates:{viewing:'<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><img src="#"><p class="clearing-caption"></p><a href="#" class="clearing-main-left"></a><a href="#" class="clearing-main-right"></a></div>'}, initialized:!1, locked:!1}, i = {}, s = {init:function (t, n) {
        return this.find("ul[data-clearing]").each(function () {
            var t = e(document), n = e(this), i = i || {}, o = o || {}, u = n.data("fndtn.clearing.settings");
            u || (i.$parent = n.parent(), n.data("fndtn.clearing.settings", e.extend({}, r, i)), s.extend(s, o), s.assemble(n.find("li")), r.initialized || s.events())
        })
    }, events:function () {
        var n = e(document);
        n.on("click.fndtn.clearing", "ul[data-clearing] li", function (t, n, r) {
        ...
        }), n.on("click.fndtn.clearing", ".clearing-main-right", function (t) {
            var n = e(".clearing-blackout").find("ul[data-clearing]");
            t.preventDefault(), s.go(n, "next")
        }), n.on("click.fndtn.clearing", ".clearing-main-left", function (t) {
            var n = e(".clearing-blackout").find("ul[data-clearing]");
            t.preventDefault(), s.go(n, "prev")
        }), n.on("click.fndtn.clearing", "a.clearing-close, div.clearing-blackout, div.visible-img", function (t) {
            var n = function (e) {
                return/blackout/.test(e.selector) ? e : e.closest(".clearing-blackout")
            }(e(this)), i, s;
            return this === t.target && n && (i = n.find("div:first"), s = i.find(".visible-img"), r.prev_index = 0, n.find("ul[data-clearing]").attr("style", ""), n.removeClass("clearing-blackout"), i.removeClass("clearing-container"), s.hide()), !1
        }), n.on("keydown.fndtn.clearing", function (t) {
            var n = e(".clearing-blackout").find("ul[data-clearing]");
            t.which === 39 && s.go(n, "next"), t.which === 37 && s.go(n, "prev"), t.which === 27 && e("a.clearing-close").trigger("click")
        }), n.on("movestart", function (e) {
            (e.distX > e.distY && e.distX < -e.distY || e.distX < e.distY && e.distX > -e.distY) && e.preventDefault()
        }), n.bind("swipeleft", "ul[data-clearing] li", function () {
            var t = e(".clearing-blackout").find("ul[data-clearing]");
            s.go(t, "next")
        }), n.bind("swiperight", "ul[data-clearing] li", function () {
            var t = e(".clearing-blackout").find("ul[data-clearing]");
            s.go(t, "prev")
        }), r.initialized = !0
    }, assemble:function (e) {
        ...
        s.locked() || (u.attr("src", this.load(e)), u.is_good(function () {
            r.addClass("clearing-blackout"), i.addClass("clearing-container"), s.caption(o.find(".clearing-caption"), e), o.show(), s.fix_height(n), s.center(u), s.shift(t, n, function () {
        ...
        }), n.closest("ul").width(n.length * 100 + "%")
        ...
        var t = e.closest("li").next(), n = e.closest("li").prev(), r, i, s, o;
        t.length > 0 && (s = new Image, r = t.find("a"), r.length > 0 ? s.src = r.attr("href") : s.src = t.find("img").attr("src")), n.length > 0 && (o = new Image, i = n.find("a"), i.length > 0 ? o.src = i.attr("href") : o.src = n.find("img").attr("src"))
        ...
        var i = t.parent(), o = i.closest(".clearing-container"), u = t.position().left, a = i.position().left, f = r.prev_index, l = this.direction(i, e, t), c = parseInt(i.css("left"), 10), h = t.outerWidth(), p;
        t.index() !== f && !/skip/.test(l) ? /left/.test(l) ? (s.lock(), i.animate({left:c + h}, 300, s.unlock)) : /right/.test(l) && (s.lock(), i.animate({left:c - h}, 300, s.unlock)) : /skip/.test(l) && (p = t.index() - r.up_count, s.lock(), p > 0 ? i.animate({left:-(p * h)}, 300, s.unlock) : i.animate({left:0}, 300, s.unlock)), n()
    }, lock:function () {
        r.locked = !0
    }, unlock:function () {
        r.locked = !1
        ...
        var s = t.find("li"), o = s.outerWidth() + s.outerWidth() / 4, u = e(".clearing-container"), a = Math.floor(u.outerWidth() / o) - 1, f = s.length - a, l = s.index(i), c = s.index(n), h;
        return r.up_count = a, this.adjacent(r.prev_index, l) ? l > a && l > r.prev_index ? h = "right" : l > a - 1 && l <= r.prev_index ? h = "left" : h = !1 : h = "skip", r.prev_index = l, h
    }, adjacent:function (e, t) {
        return t - 1 === e ? !0 : t + 1 === e ? !0 : t === e ? !0 : !1
    }, center:function (e) {
    ...
    e.fn.foundationClearing = function (t) {
        ...
        e.fn.is_good = function (t, n) {
            ...
            var r = e.extend({}, e.fn.is_good.defaults, n), i = this.find("img").add(this.filter("img")), s = i.length;
        ...
        }, e.fn.is_good.defaults = {cachePrefix:"random"}
    }(jQuery)
})(jQuery, this);
/*
...
(function (e, t, n) {
    ...
    e.fn.foundationMagellan = function (n) {
        var r = e("[data-magellan-expedition=fixed]"), i = {threshold:r.length ? r.outerHeight(!0) : 25, activeClass:"active"}, n = e.extend({}, i, n);
        e(document).on("magellan.arrival", "[data-magellan-arrival]", function (t) {
            var r = e(this).closest("[data-magellan-expedition]"), i = r.attr("data-magellan-active-class") || n.activeClass;
            e(this).closest("[data-magellan-expedition]").find("[data-magellan-arrival]").not(this).removeClass(i), e(this).addClass(i)
        });
        var s = e("[data-magellan-expedition]");
        s.find("[data-magellan-arrival]:first").addClass(s.attr("data-magellan-active-class") || n.activeClass), r.on("magellan.update-position", function () {
            var t = e(this);
            t.data("magellan-fixed-position", ""), t.data("magellan-top-offset", "")
        }), r.trigger("magellan.update-position"), e(t).on("resize.magellan", function () {
            r.trigger("magellan.update-position")
        }), e(t).on("scroll.magellan", function () {
            var i = e(t).scrollTop();
            r.each(function () {
                var t = e(this);
                t.data("magellan-top-offset") === "" && t.data("magellan-top-offset", t.offset().top);
                var r = i + n.threshold > t.data("magellan-top-offset");
                t.data("magellan-fixed-position") != r && (t.data("magellan-fixed-position", r), r ? t.css({position:"fixed", top:0}) : t.css({position:"", top:""}))
            })
        }), e(t).on("scroll.magellan", function (r) {
            var i = e(t).scrollTop();
            e("[data-magellan-destination]").each(function () {
                var t = e(this), r = t.attr("data-magellan-destination"), s = t.offset().top - i;
                s <= n.threshold && e("[data-magellan-arrival=" + r + "]").trigger("magellan.arrival")
            })
        })
    }
})(jQuery, this);
